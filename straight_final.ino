...
float angle1[3] = {0, 31.6837, -81.664};  //D
float angle2[3] = {0, 24.3135, -66.04};  //C
float angle3[3] = {0, 37.4804, -69.417};  //B
float angle4[3] = {0, 45.9798, -84.664};  //A
...
srf1.write(90);
srf2.write(65 + th2);    // was th2
srf3.write(th3 + 78);   // was th3 + 110
