...
# ---------------------------------------------------------
#  CREATE SINGLE 3D PLOT FOR EVERYTHING
# ---------------------------------------------------------
...
# Plot input points without coordinates
for x, y, z in points:
    ax.scatter(x, y, z, s=60, c='red')

# Set axes to include negative range
reach = a1 + a2 + a3
ax.set_xlim([-reach, reach])
ax.set_ylim([-reach, reach])
ax.set_zlim([-reach/2, reach])  # allow some negative Z
ax.set_xlabel("X")
ax.set_ylabel("Y")
ax.set_zlabel("Z")
...
# Text for end-effector coordinates
